  ...
  return (
    <>
      ...
      <section id="skills" className="skills">
        <div className="container">
          ...
          <div className="skills-grid">
            ...
            <div className="skill-category">
              <h3>
                <i className="fas fa-server"></i> {t.skills.categories.backend}
              </h3>
              <div className="skill-items">
                <SkillBar name="Node.js" progress={85} />
                <SkillBar name="AWS" progress={80} />
                <SkillBar name="Prisma (Mongo, PostgreSQL)" progress={82} />
            ...
            <div className="skill-category">
              <h3>
                <i className="fas fa-palette"></i> {t.skills.categories.design}
              </h3>
              <div className="skill-items">
                <SkillBar name="Git & GitHub" progress={88} />
                <SkillBar name="Adobe Creative Suite" progress={85} />
                <SkillBar name="Next.js" progress={85} />
                <SkillBar name="Responsive Design" progress={95} />
              </div>
            </div>
            ...
            <div className="skill-category">
              <h3>
                <i className="fas fa-briefcase"></i> Management & Business
              </h3>
              <div className="skill-items">
                <SkillBar name="Team Leadership" progress={92} />
                <SkillBar name="Organizational Design" progress={90} />
                <SkillBar name="Management" progress={88} />
                <SkillBar name="International Business" progress={85} />
        ...
        <div className="container">
          ...
          <div className="timeline">
            ...
            <TimelineItem
              ...
              technologies={t.experience.socialmetrix.technologies}
            />
        ...
        <div className="container">
          ...
          <div className="projects-grid">
            ...
            <ProjectCard
              ...
              technologies={["React", "Node.js", "Cloud", "Consulting"]}
            />
            ...
            <ProjectCard
              ...
              technologies={["D3.js", "JavaScript", "Data Viz", "UI Design"]}
            />
            ...
            <div className="contact-info">
              <div className="contact-item">
                ...
                <div>
                  ...
                  <a href="mailto:nicdakka@gmail.com">nicdakka@gmail.com</a>
                </div>
              </div>
              <div className="contact-item">
      ...
      <footer className="footer">
        <div className="container">
          <p>
            {new Date().getFullYear()} Nicolás Alejandro González. Todos los
            derechos reservados.
          </p>
